...
script_path = (os.path.realpath('read_fixed_len_pages'))
out_file = "out.txt"
...
print ("Running read_fixed_len_pages on 50000 tuples with pages from 1000 -> 10000000")
for p in page_size:
    p = p * 1000
    runs = []
    for i in range(num_runs):
        proc = subprocess.Popen(
            [script_path,out_file, str(p)],
