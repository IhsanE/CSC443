...
select_script_path = (os.path.realpath('select2'))
heapdir = "col_dir"
csv_num_tuples = 100
...
print ("Running select2 on 100 tuples with pages from 1000 -> 51000")
for p in page_size:
    runs = [[],[],[]]
    avgs = []
    p = p * 1000
    ...
    for i in range(num_runs):
        ...
        for combo in [("A", "Z"), ("A", "M"), ("A", "D")]:
            ...
            select_proc = subprocess.Popen(
                [select_script_path, heapdir, "0", combo[0], combo[1], str(p)],
                stdout=subprocess.PIPE
            )
